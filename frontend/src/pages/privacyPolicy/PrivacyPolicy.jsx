...
export default function PrivacyPolicy() {
  return (
    <>
      <Navbar/>
      <main className='privacyPolicy background-pattern'>
        <section className='privacyPolicy-head'>
        ...
        <section className='privacyPolicy-content'>
          <h5>Grundlegendes</h5>
          <p>Diese Datenschutzerklärung soll die Nutzer dieser Website über die Art, den Umfang und denZweck der Erhebung und Verwendung personenbezogener Daten durch den Websitebetreiber, dessen Kontaktdaten Sie dem Impressum entnehmen können, informieren.</p>
          ...
          <p>Diese Website nutzt keine Cookies zum Tracken von Nutzerverhalten oder zur Reichweitenmessung.</p>
